package com.example.rodolfoand.clanmanager.util;
...
public class JSONParser {
    ...
    private static HttpURLConnection configConnection(String url)
        ...
        con.setRequestProperty("Authorization", "Bearer "+ "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTMwOCwiaWRlbiI6IjQ2MzgyOTE2ODUyNjcyMTAyNCIsIm1kIjp7fSwidHMiOjE1MzI2NTExMDY4NzV9.os7p2I-qark0AoLDhMq-4PzHZSpd6lXP7urf4xhVhx0");
